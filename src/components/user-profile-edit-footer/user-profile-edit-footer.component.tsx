...
import { UserProfileEditFooterProps } from './user-profile-edit-footer-props.component';
import './user-profile-edit-footer.component.scss';

class EditUserProfileFooter extends Component<UserProfileEditFooterProps> {
  render() {
...
export default EditUserProfileFooter;
